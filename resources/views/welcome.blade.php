...
<body class="antialiased bg-gray-100 flex items-center justify-center min-h-screen p-4">
    <div class="w-full max-w-4xl bg-white rounded-lg shadow-lg p-8">
        ...
        <div class="flex flex-col md:flex-row items-center gap-6 mb-8">
            ...
            <div class="text-center md:text-left">
                ...
                <div class="flex gap-4 justify-center md:justify-start">
                    ...
                    <!-- Email -->
                    <a href="mailto:ralphcajipe@example.com" class="text-gray-600 hover:text-gray-900">
                        <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
                            <path
        ...
        <div class="bg-white rounded-lg shadow-lg p-8 mt-8">
            <h2 class="text-2xl font-bold text-gray-900 mb-4">featured writing</h2>
            <p class="text-gray-600 mb-4">Here are some of my short blogs on Medium:</p>
            <div class="space-y-2">
                <div>
                    <p class="text-gray-600">Feb 2022 - <a
                            href="https://medium.com/@computeralph/the-age-of-a-i-a6766679d453"
                            class="text-blue-500 hover:underline">The Age of A.I.</a></p>
                </div>
                <div>
                    <p class="text-gray-600">Feb 2022 - <a
                            href="https://medium.com/@computeralph/path-to-a-free-self-taught-education-in-computer-science-9ee6a0b79fb1"
                            class="text-blue-500 hover:underline">Path to a free self-taught education in Computer
                            Science</a></p>
                </div>
        ...
        <div class="bg-gray-200 rounded-lg shadow-lg p-8 mt-8">
            <h2 class="text-2xl font-bold text-gray-900 mb-4">research</h2>
            <div class="space-y-4">
                <!-- Research Item -->
                <div class="flex flex-col md:flex-row gap-4">
                        ...
                        <div class="mb-2">
                            <p class="text-lg font-semibold">
                                <a href="https://www.researchgate.net/publication/379037487_Video_Content_Analysis_through_Computer_Vision_and_Natural_Language_Processing"
                                    class="text-blue-500 hover:underline">Video Content Analysis through Computer
                                    Vision and Natural Language Processing</a>
                                <span class="text-green-500">2023</span>
                            </p>
                            <p class="text-red-700">Ralph Cajipe, Charles Santos, Kyle Español, Sally Segundo Jr., Kyle
                                Baltazar</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-lg p-8 mt-8">
            <h2 class="text-2xl font-bold text-gray-900 mb-4">message me</h2>
